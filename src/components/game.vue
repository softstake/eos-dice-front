    ...
    <section class="section">
        <b-modal :active.sync="showAffiliateModal" has-modal-card>
            <div class="modal-card">
                ...
                <section class="modal-card-body">
                    <p>Refer a friend and receive 0.5% of their bets! Additionally, the receiver of the referral will
                        get a 0.5% bonus towards their wins. There's no reason not to get referred and receive bigger
                        wins for each bet placed, so join our Telegram chat and hunt for a link.</p>
                </section>
            </div>
        </b-modal>
        ...
        <b-modal :active.sync="showHelpModal" has-modal-card>
            <div class="modal-card">
                ...
                <section class="modal-card-body">
                    <ol>
                        <li>Make sure you have an EOS account. For more information on how to create one, <a href="//medium.com/dapppub/create-your-own-eos-account-easily-using-the-non-service-fee-dapp-signupeoseos-b15c5347f2fc"
                                target="_blank">click here</a>.</li>
                        <li>If you haven’t already, download and install <a href="//get-scatter.com/" target="_blank">Scatter</a>,
                            an EOS wallet that facilitates interaction between users and dApps.</li>
                        ...
                        <li>If you get a notice that your transaction failed, please check that you have enough CPU
                            ...
                            to make any changes to your account!</li>
                    </ol>
                    <p>You can view your EOS balance next to the ROLL DICE button. The table below the slider bar shows
                        recent bets from all players across the world.</p>
                    <p>Still have questions? Reach out to us at <a href="//discordapp.com/channels/482077322070196225/487187255065313292"
                            target="_blank">Discord</a> and we’ll be happy to help!</p>
                </section>
            </div>
        </b-modal>
        ...
        <b-modal :active.sync="showAirdropModal" has-modal-card>
            <div class="modal-card">
                ...
                <section class="modal-card-body">
                    <p class="is-centered">BET tokens grant you instant dividend payouts based on house profit. 100% of
                        ...
                        and there is a fixed supply of 88,000,000 tokens in existence.</p>
                </section>
            </div>
        </b-modal>
