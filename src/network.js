...
export const apiUrl = isMainNet ? 'https://eos777.io/api/bets' : url.protocol + '//' + url.hostname + '/api/bets' // 'https://jungle.eos777.io/api/bets'
export const chatUrl = isMainNet ? 'ws://eos777.io/api/chat' : 'ws://' + url.hostname + '/api/chat'